...
export const ActualizarCicloEscolar = mutation({
  args: {
    ...
    escuelaID: v.optional(v.id("school")), 
  ...
  handler: async (ctx, args) => {
    ...
    if (args.escuelaID !== undefined) {
      updateData.schoolId = args.escuelaID;
    }
    if (args.nombre !== undefined) {
      updateData.name = args.nombre;
    }
    if (args.fechaInicio !== undefined) {
      updateData.startDate = args.fechaInicio;
    }
    if (args.fechaFin !== undefined) {
      updateData.endDate = args.fechaFin;
    }
    ...
    await ctx.db.patch(args.cicloEscolarID, updateData);
...
export const EliminarCicloEscolar = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    await ctx.db.delete(args.cicloEscolarID);
    return { success: true, deletedId: args.cicloEscolarID };
  },
});