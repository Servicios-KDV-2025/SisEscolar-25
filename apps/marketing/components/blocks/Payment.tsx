...
export const PaymentStatusBlock: React.FC<Props> = ({
  ...
  const imageUrl: string | null = image?.asset
    ? urlForImage(image as any)?.auto?.("format")?.url() ?? null
    : null;
                ...
                <div className="flex justify-between items-center py-3 border-b border-gray-100">
                  ...
                  <span className="text-gray-800 font-semibold">
                    {paymentInfo.subscription_current_period_start
                      ? new Date(
                          paymentInfo.subscription_current_period_start * 1000
                ...
                <div className="flex justify-between items-center py-3 border-b border-gray-100">
                  ...
                  <span className="text-gray-800 font-semibold">
                    {paymentInfo.subscription_current_period_end
                      ? new Date(
                          paymentInfo.subscription_current_period_end * 1000
                        ).toLocaleDateString("es-ES", {
                          year: "numeric",
                          month: "long",
                          day: "numeric",
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="text-center p-6 bg-emerald-50 rounded-2xl">
                ...
                <p className="text-gray-600">
                  Hemos enviado un correo de confirmación a tu email con todos
              ...
              <div className="text-center p-6 bg-blue-50 rounded-2xl">
                ...
                <p className="text-gray-600">
                  Tu cuenta ya está activa. Accede a la plataforma escolar con
                  tus credenciales.
                </p>
              </div>
            </div>
          ...
          <div className="bg-white/90 backdrop-blur-sm border border-white/30 shadow-2xl rounded-3xl p-8 mb-12">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                Si tienes alguna pregunta sobre el proceso de pago o necesitas
