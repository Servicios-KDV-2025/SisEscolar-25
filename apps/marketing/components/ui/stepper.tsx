          ...
          <>
            ...
            >
              <Button
                ...
                className={cn(classForStepButton({ dataState }))}
                ...
                {...props}
              >
                {dataState === 'completed' ? <Check /> : (icon ?? stepIndex + 1)}
              </Button>
...
const classForStepButton = cva(['rounded-full'], {
  variants: {
    dataState: {
      active: 'bg-[#3832F1]',
      completed: 'bg-[#28BF77]',
...
const classForSeparator = cva(
  [
    'bg-muted',
    'data-[state=completed]:bg-[#28BF77] data-[disabled]:opacity-50',
