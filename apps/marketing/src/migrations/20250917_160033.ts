...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_column_column_width" AS ENUM('auto', '1/1', '4/5', '3/4', '2/3', '1/2', '1/3', '1/4', '1/5');
  CREATE TYPE "public"."enum_pages_blocks_payment_status_status" AS ENUM('success', 'cancelled');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_column_column_width" AS ENUM('auto', '1/1', '4/5', '3/4', '2/3', '1/2', '1/3', '1/4', '1/5');
  CREATE TYPE "public"."enum__pages_v_blocks_payment_status_status" AS ENUM('success', 'cancelled');
  ...
  CREATE TABLE "pages_blocks_payment_status" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"status" "enum_pages_blocks_payment_status_status" DEFAULT 'success',
  	"title" varchar DEFAULT '¡Pago exitoso!',
  	"message" varchar DEFAULT 'Gracias por tu compra. Hemos recibido tu pago y tu pedido está en proceso.',
  	"image_id" integer,
  	"button_label" varchar DEFAULT 'Volver al inicio',
  ...
  CREATE TABLE "_pages_v_blocks_payment_status" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"status" "enum__pages_v_blocks_payment_status_status" DEFAULT 'success',
  	"title" varchar DEFAULT '¡Pago exitoso!',
  	"message" varchar DEFAULT 'Gracias por tu compra. Hemos recibido tu pago y tu pedido está en proceso.',
  	"image_id" integer,
  	"button_label" varchar DEFAULT 'Volver al inicio',
  ...
  CREATE TABLE "header_nav_items" (
  	...
  	"button_style" "enum_header_nav_items_button_style"
  );
  ...
  ALTER TABLE "pages_blocks_payment_status" ADD CONSTRAINT "pages_blocks_payment_status_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "pages_blocks_payment_status" ADD CONSTRAINT "pages_blocks_payment_status_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_payment_status" ADD CONSTRAINT "_pages_v_blocks_payment_status_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_payment_status" ADD CONSTRAINT "_pages_v_blocks_payment_status_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_payment_status_order_idx" ON "pages_blocks_payment_status" USING btree ("_order");
  CREATE INDEX "pages_blocks_payment_status_parent_id_idx" ON "pages_blocks_payment_status" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_payment_status_path_idx" ON "pages_blocks_payment_status" USING btree ("_path");
  CREATE INDEX "pages_blocks_payment_status_image_idx" ON "pages_blocks_payment_status" USING btree ("image_id");
  ...
  CREATE INDEX "_pages_v_blocks_payment_status_order_idx" ON "_pages_v_blocks_payment_status" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_payment_status_parent_id_idx" ON "_pages_v_blocks_payment_status" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_payment_status_path_idx" ON "_pages_v_blocks_payment_status" USING btree ("_path");
  CREATE INDEX "_pages_v_blocks_payment_status_image_idx" ON "_pages_v_blocks_payment_status" USING btree ("image_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_payment_status" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_payment_status" CASCADE;
  ...
  DROP TYPE "public"."enum_pages_blocks_payment_status_status";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_payment_status_status";
