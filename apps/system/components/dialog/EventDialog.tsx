...
export default function EventDialog({
    ...
    useState(() => {
        if (Array.isArray(ciclosEscolares) && ciclosEscolares.length > 0 && !form.getValues("schoolCycleId")) {
                                    ...
                                    <Select onValueChange={field.onChange} value={field.value}>
                                        ...
                                        <SelectContent className="w-auto max-w-[90vw] sm:max-w-[400px] min-w-[200px] p-2">
                                            {tiposDeEventos?.map((tipo) => {
                                                ...
                                                const IconComponent = iconMap[tipo.icon || "BookOpen"] || CalendarDays;
                                                    ...
                                                    <SelectItem key={tipo._id} value={tipo._id}>
                                                        <div className="flex max-w-full min-w-[200px] items-start gap-3">
                                                            ...
                                                            <div className="flex flex-col flex-grow">
                                                                <p className="font-medium text-left">{tipo.name}</p>
                                                                {tipo.description && (
