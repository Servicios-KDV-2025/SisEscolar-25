...
export function getEventColorClasses(color?: EventColor | string): string {
  ...
  switch (eventColor) {
    ...
    case "amber":
      return "bg-amber-200/50 hover:bg-amber-200/40 dark:bg-amber-400/25 dark:hover:bg-amber-400/20 dark: shadow-amber-700/8";
    case "violet":
      return "bg-violet-200/50 hover:bg-violet-200/40  dark:bg-violet-400/25 dark:hover:bg-violet-400/20 shadow-violet-700/8";
    case "rose":
      return "bg-rose-200/50 hover:bg-rose-200/40  dark:bg-rose-400/25 dark:hover:bg-rose-400/20 shadow-rose-700/8";
    case "emerald":
      return "bg-emerald-200/50 hover:bg-emerald-200/40  dark:bg-emerald-400/25 dark:hover:bg-emerald-400/20 shadow-emerald-700/8";
    case "orange":
