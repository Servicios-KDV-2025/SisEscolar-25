                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                        <div className="space-y-3">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h1 className="text-4xl font-bold tracking-tight">Ciclos Escolares</h1>
                ...
                <CardHeader>
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div>
                            ...
                            <CardDescription>
                                Encuentra los cliclos escolares por nombre, activos, archivados o inactivos
                            </CardDescription>
                        </div>
                    </div>
                </CardHeader>
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="flex items-center justify-between">
                        ...
                        <Badge variant="outline">{filteredCycles.length} ciclos escolares</Badge>
                    </CardTitle>
                </CardHeader>
                <CardContent>
                    {isLoading ? (
                        ...
                        <div className="text-center py-12">
                            ...
                            <p className="text-muted-foreground mb-4">
                                Intenta ajustar los filtros o no hay ciclos escolares registrados.
                            </p>
                            <Button
                            size="lg"
                            className="gap-2"
