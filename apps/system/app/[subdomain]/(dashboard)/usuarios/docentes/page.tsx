...
import { 
  ...
  Mail, Phone, MapPin, Calendar, UserCheck, UserX, BookOpen
} from "@repo/ui/icons";
import { teacherSchema, type TeacherWithSchoolInfo } from "@/types/form/userSchemas";

type Teacher = TeacherWithSchoolInfo;
...
const mockTeachers: Teacher[] = [
  {
    ...
    email: "elena.morales@escuela.edu.mx",
  ...
  },
  {
    ...
    email: "roberto.silva@escuela.edu.mx",
  ...
  },
  {
    ...
    name: "Carmen",
    lastName: "López Ruiz",
    email: "carmen.lopez@escuela.edu.mx", 
  ...
  },
  {
    ...
    email: "javier.hernandez@escuela.edu.mx",
...
export default function DocentesPage() {
  ...
  const filteredTeachers = useMemo(() => {
    return mockTeachers.filter((teacher) => {
      ...
      const departmentMatch = departmentFilter === "all" || teacher.userSchool?.department === departmentFilter;
  ...
  const handleCreate = async (data: Record<string, unknown>) => {
    console.log("Crear docente:", data);
  ...
  const handleDelete = async (id: string) => {
    console.log("Eliminar docente:", id);
    // Aquí iría la integración con Convex
  };
  ...
  const stats = [
    ...
    {
      title: "Activos",
      value: mockTeachers.filter(teacher => teacher.status === "active").length.toString(),
      icon: UserCheck,
      trend: "Estado activo"
    },
    {
      title: "Inactivos", 
      value: mockTeachers.filter(teacher => teacher.status === "inactive").length.toString(),
      icon: UserX,
  ...
  return (
    <div className="space-y-8 p-6">
      {/* Header */}
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-500/10 via-purple-500/5 to-background border">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-4xl font-bold tracking-tight">Docentes</h1>
                  <p className="text-lg text-muted-foreground">
                    Gestión de usuarios con permisos de enseñanza y evaluación
                  </p>
                </div>
              </div>
            </div>
        ...
        <CardHeader>
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <CardDescription>
                Encuentra docentes por nombre, email, estado o departamento
              </CardDescription>
            </div>
          </div>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center justify-between">
            ...
            <Badge variant="outline">{filteredTeachers.length} usuarios</Badge>
          </CardTitle>
        </CardHeader>
        <CardContent>
                ...
                {filteredTeachers.map((teacher) => (
                  <TableRow key={teacher._id}>
                    <TableCell>
                      <div className="flex items-center gap-3">
                        <Avatar className="h-10 w-10">
                          <AvatarImage src={teacher.imgUrl} alt={teacher.name} />
                    ...
                    <TableCell>
                      <Badge 
                        variant="outline" 
                        className={getDepartmentColor(teacher.userSchool?.department)}
                      >
                        {getDepartmentLabel(teacher.userSchool?.department)}
                      </Badge>
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-1 text-sm">
                        ...
                        {formatDate(teacher.admissionDate)}
                      </div>
                    </TableCell>
          ...
          {filteredTeachers.length === 0 && (
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-medium mb-2">No se encontraron docentes</h3>
              <p className="text-muted-foreground mb-4">
                Intenta ajustar los filtros o agregar un nuevo docente.
              </p>
      ...
      <CrudDialog
        ...
        deleteConfirmationTitle="¿Eliminar docente?"
        deleteConfirmationDescription="Esta acción eliminará permanentemente al docente del sistema. Esta acción no se puede deshacer."
      >
